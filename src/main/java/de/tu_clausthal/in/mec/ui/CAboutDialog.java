...
public class CAboutDialog extends JDialog
{
    ...
    protected JPanel getBuildData()
    {
        ...
        l_layout.gridx = 0;
        l_layout.gridy = 1;
        l_panel.add( new JLabel( CCommon.getResourceString( this, "buildnumber" ), JLabel.RIGHT ), l_layout );
        l_layout.gridx = 1;
        l_panel.add( Box.createHorizontalStrut( 20 ) );
        l_layout.gridx = 2;
        ...
        l_layout.gridx = 0;
        l_layout.gridy = 2;
        l_panel.add( new JLabel( CCommon.getResourceString( this, "buildcommit" ), JLabel.RIGHT ), l_layout );
        l_layout.gridx = 1;
        l_panel.add( Box.createHorizontalStrut( 20 ) );
        l_layout.gridx = 2;
        ...
        l_layout.gridx = 0;
        l_layout.gridy = 3;
        l_panel.add( new JLabel( CCommon.getResourceString( this, "license" ), JLabel.RIGHT ), l_layout );
        l_layout.gridx = 1;
        l_panel.add( Box.createHorizontalStrut( 20 ) );
        l_layout.gridx = 2;
