...
/**
 * dummy waypoint class
 * @param <T>
 * @param <P>
 * @param <N>
 */
public class CDummyWaypoint<T, P extends IFactory<T>, N extends IGenerator> extends IWayPointBase<T, P, N>
{
    ...
    {
        super( p_position, p_color, p_name );
    }
