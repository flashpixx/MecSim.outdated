...
var defaultLon = 0;
var selected = false;
var sortComp = sortByDistanceComp;
...
//method to init the cluster widget
function initClusterWidget(){
...
function linkWrapper(nodeArray) {
  var map = {};
  var targets = [];
...
function leftclick(nodeclicked){
...
function rightclick(nodeclicked){
  /**
...
function sortByDistanceComp(a, b){
