...
public class CMain
{
    ...
    public static void main( String[] p_args )
    {
        ...
        CLogger.out( CCommon.getResouceString( CMain.class, "memory", c_neededmemory, Runtime.getRuntime().maxMemory() / c_gb ), Runtime.getRuntime().maxMemory() / c_gb < c_neededmemory );
